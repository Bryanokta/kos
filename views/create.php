...
<head>
    <meta charset="UTF-8">
    <title>Tambah Penghuni Kos</title>
        ...
        <form action="index.php?action=create" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="tipe_sewa" id="tipe_sewa" onchange="toggleSeats()" required>
                    <option value="Sharing">Sharing (Maks 2 Orang)</option>
                    <option value="Private">Private (1 Kamar Penuh)</option>
                </select>
            </div>
            <div class="form-group">
                    ...
                    <?php foreach ([1, 2, 3, 4] as $row): ?>
                        ...
                        <?php foreach (['A', 'B', 'C', 'D'] as $col): ?>
                            ...
                            <label class="seat-wrapper">
                                <input type="radio" name="kamar" value="<?= $kamar_id ?>" class="<?= $input_class ?>" required <?= $disabled ?>>
    ...
    <script>
        function toggleSeats() {
            ...
            halfSeats.forEach(seat => {
                ...
                if (isPrivate && seat.checked) seat.checked = false;
            });
        }
